...
btn_se4 = types.InlineKeyboardButton('В основное меню', callback_data='menu')
Keyboard_Settings.add(btn_se1, btn_se2, btn_se3, btn_se4)
...
btn_sen4 = types.InlineKeyboardButton('Отправлять всегда в расширении tar', callback_data='always_tar')
